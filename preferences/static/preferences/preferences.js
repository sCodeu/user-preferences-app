    ...
    webix.ajax().get("http://localhost:8000/api/preferences/me/", {
        ...
        success: function (text, data) {
            ...
            try {
                ...
                webix.message({ type: "error", text: "Failed to load user preferences (invalid response)." });
                return;
            }
        ...
        error: function () {
            webix.message({ type: "error", text: "Authentication required. Redirecting to login..." });
            $$("home_view").setHTML("Please log in to view preferences.");
        }
    });
}

function savePreferences() {
    const forms = ["account_form", "notification_form", "theme_form", "privacy_form"];
    const allValid = forms.every(formId => {
        const valid = $$(formId).validate();
        if (!valid) webix.message({ type: "error", text: `Validation failed in: ${formId}` });
        return valid;
    });
    ...
    rows: [
        {
            view: "toolbar",
            elements: [
                { view: "label", id: "toolbar_label", label: "User Preferences ",css: "custom-toolbar-label" },
                {},
                {
                    view: "button",
                    label: "Logout",
                    ...
                    rows: [
                        {
                            ...
                            elements: [
                                { view: "text", label: "Username", name: "username", css: "rounded-box" },
                                { view: "text", label: "Email", name: "email", css: "rounded-box" },
                                {
                                    view: "button", value: "Save", align: "center",
                                    click: savePreferences , css: "save-button"
                                }
                            ]
                        }
                    ]
                    ...
                    rows: [
                        {
                            ...
                            elements: [
                                { view: "checkbox", labelRight: "Email Notifications", name: "email_notifications" },
                                { view: "checkbox", labelRight: "Push Notifications", name: "push_notifications" },
                                {
                                    view: "richselect",
                                    label: "Frequency",
                    ...
                    rows: [
                        {
                            ...
                            responsive: true,
                            elements: [
                                { view: "text", label: "Theme Color", name: "theme_color", css: "rounded-box", labelWidth: 120 },
                                { view: "text", label: "Font Size", name: "font_size", css: "rounded-box", labelWidth: 120 },
                                { view: "text", label: "Layout", name: "layout", css: "rounded-box", labelWidth: 120},
                                {
                                    view: "button", value: "Save", align: "center",
                                    click: savePreferences, css: "save-button"
                                }
                    ...
                    rows: [
                        {
                            ...
                            responsive: true,
                            elements: [
                                { view: "checkbox", labelRight: "Profile Visible", name: "profile_visible" },
                                { view: "checkbox", labelRight: "Data Sharing", name: "data_sharing" },
                                {
                                    view: "button", value: "Save", align: "center",
                                    click: savePreferences, css: "save-button"
                                }
